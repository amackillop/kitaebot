...
artifact and its stated intent into the prompt, plus `review` metadata
(repo, gate, git_ref) so the verdict lands in the findings ledger.
These gates supersede reviewing your own staged diff in-context: the
reviewer sees the artifact cold, which is the point.
...
human sign-off arbitrate. A clean verdict needs no action, and a
failed reviewer call is a skipped review — proceed on your own
judgment.
