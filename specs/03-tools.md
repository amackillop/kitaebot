...
1. **Regex layer** — a compiled `RegexSet` of ~60+ patterns covering:
   ...
   compound commands retain the regex check. `rg --pre` is blocked because
   it executes a preprocessor for every searched file.
